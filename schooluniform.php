...
$sql = "SELECT p.*, c.parent_name, c.email FROM products p 
        ...
        WHERE p.category = 'School Uniform'";
...
<head>
  <meta charset="UTF-8">
  <title>School Uniform | Trade Buddy</title>
...
<div class="container py-5">
  <div class="row mb-4">
    <div class="col text-center">
      <h2>Products listed under the category "School Uniform"</h2>
    </div>
  </div>

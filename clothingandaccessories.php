...
<head>
  <meta charset="UTF-8">
  <title>Clothing and Accessories | Trade Buddy</title>
...
<header class="text-white text-center"
        style="background-image: url('images/clothingandaccessories.png'); 
               background-size: cover; 
               background-position: center; 
               min-height: 400px;">
  <div class="bg-dark bg-opacity-50 h-100 d-flex align-items-center justify-content-center">
    <h1 class="w-100">Clothing and Accessories</h1>
  </div>
</header>
...
<div class="container py-5">
  <div class="row mb-4">
    <div class="col text-center">
      <h2>Products listed under the category "Clothing and Accessories"</h2>
    </div>
  </div>

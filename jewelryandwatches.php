...
<head>
  <meta charset="UTF-8">
  <title>Jewelry and Watches | Trade Buddy</title>
...
<header class="text-white text-center"
        style="background-image: url('images/jewelryandwatches.png'); 
               background-size: cover; 
               background-position: center; 
               min-height: 400px;">
  <div class="bg-dark bg-opacity-50 h-100 d-flex align-items-center justify-content-center">
    <h1 class="w-100">Jewelry and Watches</h1>
  </div>
</header>
...
<div class="container py-5">
  <div class="row mb-4">
    <div class="col text-center">
      <h2>Products listed under the category "Jewelry and Watches"</h2>
    </div>
  </div>

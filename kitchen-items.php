...
<?php
$sql = "SELECT p.*, c.parent_name, c.email FROM products p 
        JOIN customers c ON p.customer_id = c.id 
        WHERE p.category = 'Household'"; // Update this if you use a separate 'Kitchen' category
...
<head>
  <meta charset="UTF-8">
  <title>Kitchen Items | Trade Buddy</title>
...
<div class="container py-5">
  <div class="row mb-4">
    <div class="col text-center">
      <h2>Products listed under the category "Kitchen Items"</h2>
    </div>
  </div>

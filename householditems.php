...
<head>
	<meta charset="UTF-8">
	<title>Household Items | Trade Buddy</title>
...
<div class="container py-5">
	<div class="row mb-4">
		<div class="col text-center">
			<h2>Products listed under the category "Household Items"</h2>
		</div>
	</div>
